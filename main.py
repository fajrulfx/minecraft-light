...
# https://sciencekingdom.gg/discord
...
bulb = Bulb("XX.XX.XX.XX") # bulb IP adress. Can be seen in Yeelight app
mc = Minecraft.create(address="XX.XX.XX.XX", port=25565) #Minecraft server IP address. If you use your own computer, you can just use Minecraft.create()

GREEN = False; RED = False; BLUE = False; YELLOW = False
